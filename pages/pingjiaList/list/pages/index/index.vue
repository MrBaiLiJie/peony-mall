<template>
	<view id="moments">
		<view class="moments__post" v-if="comments.length && !loading" v-for="(item, index) in comments" :key="index" :id="'post-'+index">
			<view class="post-left">
				<image class="post_header" :src="item.umsIcot? item.umsIcot : '../../../../../static/nanzhuang.jpg'"></image>
			</view>

			<view class="post_right">
				<text class="post-username">{{item.userName}}</text>
				<view id="paragraph" class="paragraph" style="color:#ccc">{{item.createdAt}}</view>
				<!-- 星星-->
			    <uni-rate disabled="true"size="17" :value="item.star"></uni-rate>
				<!-- 内容 -->
        	...
        	<view v-if="comments.length == 0" style="text-align: center;margin:60upx auto">
				<image src="../../../../../static/zwpj.png"></image>
				<!-- <img src="../../static/index/zwpj.png" alt=""> -->
