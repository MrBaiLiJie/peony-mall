	...
	<view>
		...
		<view class="category-list">
			...
			<scroll-view scroll-y="true" class="left">
				<view class="row" v-for="(category, index) in classification" :key="index" :class="[index == showCategoryIndex ? 'on' : '']" @tap="showCategory(index)">
					<view class="text">
			...
			<scroll-view scroll-y="true" class="right">
				<view class="category" v-for="(category, index) in classification" :key="index" v-show="index == showCategoryIndex">
					<!-- <view class="banner"><image :src="category.banner"></image></view> -->
					<view class="list">
						<view class="box" v-for="(box, i) in category.sons" :key="i" @tap="toCategory(box)">
							<image :src="box.icon ? box.icon : '../../static/img/category/list/nanzhuang.jpg'"></image>
