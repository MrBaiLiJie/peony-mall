<template>
  <view class="calendar-content">
    ...
    <button
      ...
      type="button"
      @click="open">打开日历</button>
    <text
      v-if="timeData.lunar"
      class="calendar-title">已选日期</text>
    <view
      v-if="timeData.lunar"
      class="calendar-info">
    ...
    <view
      ...
      <view
        ...
        <uni-calendar
          ...
          :fixed-heihgt="tags[1].checked"
          :slide="slide"
          :disable-before="tags[6].checked"
        ...
        <view class="calendar-button-groups">
          <button
            class="calendar-button-confirm"
            @click="closeMask">取消</button>
          <button
            class="calendar-button-confirm"
