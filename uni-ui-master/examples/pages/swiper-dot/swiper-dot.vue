  ...
  <view class="content">
    ...
    <view class="uni-swiper__box">
      ...
      <view class="uni-swiper__info">
        <view
          :class="{'active':modeIndex === 0}"
          class="uni-swiper__info-item"
          @click="selectMode('default',0)"
        >default</view>
        <view
          :class="{'active':modeIndex === 1}"
          class="uni-swiper__info-item"
          @click="selectMode('long',1)"
        >long</view>
        <view
          :class="{'active':modeIndex === 2}"
          class="uni-swiper__info-item"
          @click="selectMode('nav',2)"
        >nav</view>
        <view
          :class="{'active':modeIndex === 3}"
          class="uni-swiper__info-item"
          @click="selectMode('indexes',3)"
        >indexes</view>
      </view>
    </view>
    <view class="uni-swiper__box">
      ...
      <view class="uni-swiper__info">
        <template v-if="mode !== 'nav'">
          ...
          >
            <view
              :style="{'background-color':item.selectedBackgroundColor,border:item.selectedBorder,}"
              class="uni-swiper__info-dots"
            />
            <view
