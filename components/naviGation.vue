<template>
	<view class="header">
		...
		<view class="input-box">
			<!-- <view class="area" v-for="(item, index) in area" :key="index"> -->
			<!-- 	<image :src="item.img" mode=""></image>
				<view class="text" style="color: #FFFFFF;margin-right:10upx; font-size: 24upx;">青岛市市南区</view> -->
				<!-- <image class="img2" style="width: 50upx;height: 50upx; margin-left: 20upx; margin-right: 20upx;" src="../../static/img/scan.png" mode=""></image> -->
			<!-- </view> -->
			<input placeholder="搜索" placeholder-style="color:#c0c0c0;" @tap="toSearch()" />
			<view class="icon search"></view>
		</view>
		<!-- 右侧图标按钮 -->
		<!-- <view class="icon-btn"><view class="icon tongzhi" @tap="goMsg()" style="color: #FFFFFF;"></view></view> -->
	</view>
</template>
<script>
export default {
