...
<script>
	export default {
		props:{
			...
			headPicValue:{
				type:String,
				default:require('../static/st_pic.png')
			},
			...
			starDefault:{ //未选中
				type:String,
				default:require('../static/st_star.png'),
			},
			starActive:{
				type:String,
				default:require('../static/st_star_active.png'),
			},
			score:{  //默认分数
				type:[Number,String],
				default:0
