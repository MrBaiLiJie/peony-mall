<template>
	<view class="uni-countdown">
        ...
        <view class="uni-countdown__number" :style="{borderColor:borderColor, color:color, background:backgroundColor}">限时购</view>
		...
		<view v-if="!showColon" class="uni-countdown__splitor">秒</view>
	</view>
</template>
<script>
	export default {
